...
class MeterDialog(QDialog):
    ...
    def _on_test_clicked(self):
        ...
        try:
            ...
            print(f"[pb_test] Writing parameter 23=1 for {self._node.port}/{self._node.address}")
            try:
                write_ok = inst.writeParameter(23, 1)
                write_line = f"param 23 write: value=1 ok={write_ok!r}"
