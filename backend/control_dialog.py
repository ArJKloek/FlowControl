    ...
    def _send_setpoint_pct(self):
        ...
        try:
            ...
            if hasattr(self.manager, 'error_logger'):
                ...
                self.manager.error_logger.log_setpoint_error(
                    port=self._node.port,
                    address=self._node.address,
                    error_message=f"Percentage setpoint error: {e}",
                    instrument_info=instrument_info
                )
        ...
        try:
            ...
            if hasattr(self.manager, 'error_logger'):
                ...
                self.manager.error_logger.log_error(
                    ...
                    address=self._node.address,
                    error_type="usertag",
                    error_message="Usertag update failed",
                    error_details=str(e),
                    instrument_info=instrument_info
                )
